...
<body>
    @if (Route::has('login'))
        <div class="container-fluid bg-gray-800 vh-100 d-flex justify-content-center align-items-center" style="min-height: 100vh">
            <div class="card bg-light shadow-lg" style="width: 18rem; height: auto">
                <img src="{{ asset('img/logo-certa.png') }}" class="card-img-top mx-auto mt-3" style="height: 4rem; width: 4rem;">
                <div class="card-body text-center">
                    ...
                    <div class="mb-2">
                        <nav class="d-flex flex-column gap-2 justify-content-center">
                            @auth
                                <a href="{{ url('/dashboard') }}" class="btn btn-outline-info">Painel Inicial</a>
                            @else
